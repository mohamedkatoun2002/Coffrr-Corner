                                ...
                                @if ($cartProducts->count() > 0)
                                    @foreach ($cartProducts as $cartProduct)
                                        <tr class="text-center">
                                            ...
                                            <td class="image-prod">
                                                <div class="img"
                                                    style="background-image:url({{ asset('assets/images/' . $cartProduct->image . '') }});">
                                                </div>
                                            </td>
                ...
                <div class="col col-lg-3 col-md-6 mt-5 cart-wrap ftco-animate">
                    ...
                    @if ($cartProducts->count() > 0)
                        <form method="POST" action="{{ route('prepare.checkout') }}">
                            ...
                            <button type="submit" name="submit" class="btn btn-primary py-3 px-4">Proceed
                                to
                                Checkout</button>
                            </p>
                        </form>
                    @else
                        <p class="text-center alert alert-success"> You Cannot checkout because you have no items in
                            cart
                        </p>
                    @endif
                </div>
